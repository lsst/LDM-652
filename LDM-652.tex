...
% Most recent last
\setDocChangeRecord{%
	\addtohist{1}{\today}{Initial charge}{Leanne P. Guy}
}
...
analysis of the LSST data. The platform exposes the LSST data and services to the user through three primary user facing
...
\item Is the traceability of requirements from higher design documents, e.g \citeds{LPM-17}: LSST Science Requirements Document  
to \citeds{LDM-554}:LSST Science Platform Requirements complete and will it ensure coverage of the four key LSST science themes?
%
...
\item Does the design presented in \citeds{LDM-542} capture the requirements for the LSP as detailed in \citeds{LDM-554}.
%
...
%
% No risks have ever been defined for the LSP. The  risk register is not very well matched and not matched to what we ended up building. 
