...
\title[Charge for \product~Final Design Review]{\product~Final Design Review}

\author{Leanne~P.~Guy}
\setDocRef{\lsstDocType-\lsstDocNum}
\setDocDate{2019-02-12}
...
\setDocChangeRecord{%
	...
	\addtohist{0.3}{2018-11-08}{Updates from RFC-543}{Leanne Guy}
	\addtohist{1.0}{2018-12-05}{Approved in RFC-543}{Leanne Guy}
	\addtohist{1.1}{2019-02-12}{Fix \LaTeX ~issue. No content change}{Leanne Guy}
}
...
\label{sec:scope}
This is the Final Design Review of the LSST Science Platform (LSP), as defined and described in \citeds{LSE-319}: LSST Science Platform Vision Document.
